...
<head>
    ...
    <script type="text/javascript" src="Vols.js"> </script>
...
<body>
    ...
    <span id="lieuvol_quest">Vous Allez à Rome</span><br/> 
      <span id="lieu_depart"> Départ  : </span>
        <select class="selection" name="depart" required>
      ...
      <span id="lieu_arrivee"> Arrivée  : </span>
        <select class="selection" name="arrivee">
    ...
    if(isset($_POST['dest'])){
      ...
      foreach($products as $vol):
        ...
        if($vol->vol_placetot > 0 && $vol->hdep == '14:00:00'){
          echo "<div id='aprem'>
          <div class='vol'>
          <div class='compagnie'>".$vol->compagnie." Départ : ".$vol->hdep."
          <img src='https://cdn.glitch.com/8c002ad1-d654-4590-a703-a8d0dccd8d4b%2Farrow.svg?v=1575588319091' width='15'> ".$vol->har."</div></div>
        ...
        if($vol->vol_placetot > 0 && $vol->hdep == '20:00:00'){
          echo "<div id='soir'>
          <div class='vol'>
          <div class='compagnie'>".$vol->compagnie." Départ : ".$vol->hdep."
          <img src='https://cdn.glitch.com/8c002ad1-d654-4590-a703-a8d0dccd8d4b%2Farrow.svg?v=1575588319091' width='15'>  ".$vol->har."</div></div>
