...
<html>
  ...
  <head>
    <title>Nager avec les Tortues</title>
  ...
  <body>
      ...
      <div class="cache" id="filtre">
        ...
        <div id="sectionfiltre">
          ...
          <section class="q">
            ...
            <button class="compter" onclick="compteur(-1)">-</button>
            <span id="nb_personne"> 1</span>
            <button class="compter" onclick="compteur(1)">+</button>  
          </section>
    ...
    <?php
      if (isset($_POST['dest'])){
        ...
        $products= $DB->query("SELECT * FROM activite WHERE lieuact= '$choix' AND nact=5" );
        echo '<div id="offres">';
        foreach($products as $product):
          if($product->act_placetot > 0){
            echo "<div class='act'>
            <p class='nomact'>".$product->nomact."</p>
            <p class='descri'>".$product->act_desc." </p><br>
            <p class='leprix'> Prix: ".$product->prixact." €</p>
            <button class='panier'><a class='addPanier' href='addpanier.php?nact=".$product->nact."'>Ajouter Au Panier ! </a></button></div>";
          }
          else{
            echo "<div class='act'>
            <p class='nomact'>".$product->nomact."</p>
            <p class='descri'>".$product->act_desc." </p><br>
            <p class='act_rupt'> Il n'y a plus de tickets pour cette activité... </p></div>";
          }
        endforeach;
